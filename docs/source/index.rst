...
You now have a Metapack package in the :file:`metatab.org-tutorial` directory, with two example data resources. Build the schemas for the resources with: 

.. code-block:: bash

    $ mp pack -s metatab.org-tutorial/
    
Now the `Schema` section of the :file:`metatab.org-tutorial/metadata.csv` file
has autogenerated schemas for the two resources. Finally, build the data
packages with:
